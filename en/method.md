...
→ [Pace Planner](pace-planner.md)

### Scale-Free Planner
For long-range planning across all horizons at once. Tasks are assigned to time slots whose width grows with distance from the present. As time passes, distant slots ripen and divide into narrower ones — plans are never discarded and rebuilt, they accumulate and refine. Works naturally for shared planning between two or more people.
