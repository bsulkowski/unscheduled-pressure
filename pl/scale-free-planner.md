...
Zadania i plany przydzielane są do przedziałów czasowych. Przedziały są skwantowane — stanowią stały zestaw interwałów — ale ich szerokość rośnie wraz z odległością od teraźniejszości. Typowy zestaw przedziałów może wyglądać tak:
...
W razie potrzeby można dodać kolejne przedziały.
